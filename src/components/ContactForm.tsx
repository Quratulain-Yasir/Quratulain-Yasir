...
<div className="w-full h-full">
  <motion.form
    ...
    viewport={{ once: true }}
    className="rounded-lg p-8 shadow-lg hover:shadow-purple-800 active:shadow-purple-800 flex flex-col justify-between h-full bg-[#2E035F] transition-all duration-300 ease-in-out hover:scale-105 active:scale-105"
  >
            {/* Name */}
            <motion.div
              className="mb-6"
