...
<div className="flex items-center gap-6 justify-between px-2 pb-10 lg:pb-5 lg:py-5">
       ...
       <div className="stack-note lg:text-base text-xs text-[#d8cfc4] lg:px-8">
        React & Node.js<br/>
        Vercel · REST APIs
      </div>
</div>
      ...
      >
       ...
       <div className="absolute lg:bottom-0 bottom-29 right-[0.5px] bg-purple-800 text-white text-[0.68rem] tracking-[0.2em] uppercase lg:px-5 lg:py-3 px-3 py-2 lg:font-medium font-light lg:mr-12 mr-2 rounded-full">Web Developer · Faisalabad</div>
    </section>
  );
};
