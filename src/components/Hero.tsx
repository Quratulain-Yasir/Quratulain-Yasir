...
const Hero = () => {
  ...
  <section id="home" className="min-h-screen flex  flex-col-reverse md:flex-row px-6 sm:px-25 py-20 lg:py-25 pb-10  text-[#F3F4F6] bg-[#362072] items-center">
      ...
      <div className="md:w-3/4">
        ...
        <h1 className="text-5xl lg:text-6xl leading-tighter mt-10 lg:mt-12 lg:mb-6 font-bold">
...
<div className="flex items-center gap-6 justify-between px-2 pb-10 lg:pb-5 lg:py-5">
        ...
        <button className="h-[8vh] sm:h-[9vh] border-2 border-[rgba(40, 19, 90, 1)] pl-5 pr-2 py-1 rounded-full text-[#d8cfc4] hover:text-[#d8cfc4] shadow-md transition font-one text-sm lg:text-lg inline-flex gap-2 sm:gap-3 items-center hover:scale-105 focus:scale-105 duration-300 ease-in-out mt-4 z-10">
      ...
      <motion.div
        ...
        className="w-[75vw] lg:w-[40vw] h-full transform hover:rotate-1 hover:scale-105 transition focus:scale-102 duration-300 ease-in-out relative"
      >
